---
title: "Case Study: Arctic96AD-7 sp002082305 (SAR324)"
subtitle: "Species ID 2269_1 - gene content, biogeography, and pN/pS across subspecies"
output:
  html_document:
    toc: true
    toc_float: true
...
```{r chunk-18}
#####
# Identify PFAM families exhibiting differential selective pressure across
# subspecies, based on a significant fold-change of pNpS values across
...
# ### Import PFAM accession to description and add to table
# pfam_desc = fread(paste0(input_dir,"pfam_accession_to_description.txt"), sep = "\t", header=T)

# sp_core_pfam_pop_signif_diff_w_desc = sp_core_pfam_pop_signif_diff %>%
#     left_join(pfam_desc, by="PFAM_accession")
